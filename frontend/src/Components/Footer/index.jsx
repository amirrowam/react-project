...
export default function Footer() {
  return (
    <>
      <div className='bg-gray-500 text-stone-300 lg:px-12 transition-all grid grid-cols-1 lg:grid-cols-3'>

        <div className='mx-6 my-6 lg:my-0'>
        ...
        <div className='mx-6 my-6 lg:my-0'>
          ...
          <div className='flex gap-3'>
            <div className='flex flex-col mr-1 child-hover:text-orange-400'>
              <div className='transition-all'>- Privacy</div>
              <div className='transition-all'>- Product Invite</div>
              <div className='transition-all'>- Terms of Use</div>
              <div className='transition-all'>- Privacy</div>
              <div className='transition-all'>- Product Invite</div>
              <div className='transition-all'>- Terms of Use</div>
            </div>
            <div className='flex flex-col ml-1 child-hover:text-orange-400'>
              <div className='transition-all'>- FAQs</div>
              <div className='transition-all'>- Job Opportunities</div>
              <div className='transition-all'>- Guarantee Letters</div>
              <div className='transition-all'>- Privacy</div>
              <div className='transition-all'>- Product Invite</div>
              <div className='transition-all'>- Terms of Use</div>
            </div>
